  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="guruadmin.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="siswaadmin.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>Siswa</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <td class="align-middle text-left">1313131311</td>
                    <td class="align-middle text-left">Budi</td>
                    <td class="align-middle text-left">budi@gmail.com</td>
                    <td class="align-middle text-left">Jl.Welllllllllllllllllllllllllllllll</td>
                    <td class="align-middle text-left">08112334556</td>
                    <td class="align-middle text-left">Laki-laki</td>
                    <td><img src="../assets/img/team-1.jpg" width="100px" ;></td>
                    <td class="text-xs font-weight-bold">
                      <a class="btn btn-success" data-bs-toggle="modal" data-bs-target="#EditSiswa">Ubah</a>
